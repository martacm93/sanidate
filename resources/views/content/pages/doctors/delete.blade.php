...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h3 class="mb-0">Delete Doctor</h3>
        </div>
        <form class="card-body" action="{{ route('pages-doctors-destroy') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <div class="input-group input-group-merge">
                        <input type="text" name="annual_salary" value="{{ $doctor->annual_salary }}"
                            id="multicol-annual_salary" class="form-control" readonly />
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-check mt-3">
                        <input name="active" class="form-check-input" type="radio" value="1" id="defaultRadio1"
                            disabled @if ($doctor->active == 1) checked @endif />
                    ...
                    <div class="form-check">
                        <input name="active" class="form-check-input" type="radio" value="0" id="defaultRadio2"
                            disabled @if ($doctor->active == 0) checked @endif />
